...
#endif
    //jinlong       
        {"CCI_SW",AP_CFG_CUSTOM_FILE_CCI_SW_LID},
	{"ACER_NUMBER",AP_CFG_CUSTOM_FILE_ACER_NUMBER_LID},
	{"ACER_NUMBER_SNID",AP_CFG_CUSTOM_FILE_ACER_NUMBER_SNID_LID},
        {"Warranty_Info",AP_CFG_REEB_FILE_WARRANTY_INFO_LID},
    //jinlong
};
...
#endif
//jinlong
  NULL,//AP_CFG_CUSTOM_FILE_CCI_SW_LID  
  NULL,//AP_CFG_CUSTOM_FILE_ACER_NUMBER_LID
  NULL,//AP_CFG_CUSTOM_FILE_ACER_NUMBER_SNID_LID
  NULL,//AP_CFG_REEB_FILE_WARRANTY_INFO_LID
//jinlong
};
