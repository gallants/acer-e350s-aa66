...
#include "../cfgfileinc/CFG_CCI_SW_File.h"   //jinlong
#include "../cfgdefault/CFG_CCI_SW_Default.h"   //jinlong
#include "../cfgfileinc/CFG_ACER_NUMBER_File.h"   //jinlong
#include "../cfgdefault/CFG_ACER_NUMBER_Default.h"   //jinlong
#include "../cfgfileinc/CFG_ACER_NUMBER_SNID_File.h"   //jinlong
#include "../cfgdefault/CFG_ACER_NUMBER_SNID_Default.h"   //jinlong
#include "../cfgfileinc/CFG_Warranty_File.h"   //jinlong
#include "../cfgdefault/CFG_Warranty_Default.h"   //jinlong
#include <stdio.h>
#ifdef __cplusplus
extern "C"
{
  ...
  //jinlong
	...
	{
            "/data/nvram/APCFG/APRDEB/ACER_NUMBER",         VER(AP_CFG_CUSTOM_FILE_ACER_NUMBER_LID),	           CFG_FILE_ACER_NUMBER_REC_SIZE,
            CFG_FILE_ACER_NUMBER_REC_TOTAL,                  SIGNLE_DEFUALT_REC,                (char *)&stACER_NUMBERDefault, DataReset , NULL
        },  
        {
            "/data/nvram/APCFG/APRDEB/ACER_NUMBER_SNID",         VER(AP_CFG_CUSTOM_FILE_ACER_NUMBER_SNID_LID),	           CFG_FILE_ACER_NUMBER_SNID_REC_SIZE,
            CFG_FILE_ACER_NUMBER_SNID_REC_TOTAL,                  SIGNLE_DEFUALT_REC,                (char *)&stACER_NUMBER_SNIDDefault, DataReset , NULL
        }, 
