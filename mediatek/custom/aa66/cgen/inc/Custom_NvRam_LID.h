...
//    AP_CFG_CUSTOM_FILE_CUSTOM2_LID,
    ...
    AP_CFG_CUSTOM_FILE_CCI_SW_LID,   //add by jinlong
    AP_CFG_CUSTOM_FILE_ACER_NUMBER_LID,  //add by jinlong
    AP_CFG_CUSTOM_FILE_ACER_NUMBER_SNID_LID,  //add by jinlong
    AP_CFG_REEB_FILE_WARRANTY_INFO_LID,  //add by jinlong
...
#define AP_CFG_CUSTOM_FILE_CCI_SW_LID_VERNO                     "000"       //jinlong
#define AP_CFG_CUSTOM_FILE_ACER_NUMBER_LID_VERNO                "000"       //jinlong
#define AP_CFG_CUSTOM_FILE_ACER_NUMBER_SNID_LID_VERNO                "000"       //jinlong
#define AP_CFG_REEB_FILE_WARRANTY_INFO_LID_VERNO                "000"       //jinlong
/* WIFI file version */
