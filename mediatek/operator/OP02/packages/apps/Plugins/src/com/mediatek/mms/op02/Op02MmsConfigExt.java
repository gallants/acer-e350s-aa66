...
public class Op02MmsConfigExt extends MmsConfigImpl{
    private static final String TAG = "Mms/Op02MmsConfigExt";
    
    private static int mOp02SmsToMmsThreshold = 4;//change 10 to 4 for Acer by timo;
    ...
    public boolean isEnableSIMSmsForSetting(){
        Xlog.d(TAG, "Disable SIM Message at setting ");
        return false;
    }
}
