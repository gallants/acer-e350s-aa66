...
public class OmacpApn {
     ...
     */
    protected static final String[] sProjection = new String[] {
    ...
    public ArrayList<Map<String, String>> query() {
        ...
        if(cursor != null){
            ...
            while (!cursor.isAfterLast()) {
                ...
                apnProp.put(sProjection[NAME_INDEX], cursor.getString(NAME_INDEX));
                apnProp.put(sProjection[APN_INDEX], cursor.getString(APN_INDEX));
                apnProp.put(sProjection[PROXY_INDEX], cursor.getString(PROXY_INDEX));
                apnProp.put(sProjection[PORT_INDEX], cursor.getString(PORT_INDEX));
                apnProp.put(sProjection[USER_INDEX], cursor.getString(USER_INDEX));
                apnProp.put(sProjection[SERVER_INDEX], cursor.getString(SERVER_INDEX));
                apnProp.put(sProjection[PASSWORD_INDEX], cursor.getString(PASSWORD_INDEX));
                apnProp.put(sProjection[MMSPROXY_INDEX], cursor.getString(MMSPROXY_INDEX));
                apnProp.put(sProjection[MMSPORT_INDEX], cursor.getString(MMSPORT_INDEX));
                apnProp.put(sProjection[MMSC_INDEX], cursor.getString(MMSC_INDEX));
                apnProp.put(sProjection[MCC_INDEX], cursor.getString(MNC_INDEX));
                apnProp.put(sProjection[AUTH_TYPE_INDEX], cursor.getString(AUTH_TYPE_INDEX));
                apnProp.put(sProjection[TYPE_INDEX], cursor.getString(TYPE_INDEX));
